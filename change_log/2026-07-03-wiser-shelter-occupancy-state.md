...
- Canonical real run: `D:\Field2026_analysis_out\sleep_site_cv_crossval_20260706_2303` (verdict + reconciliation
  strata + `cv_recall_gap_flags.csv` + manifest). Read-only on the WISER snapshot + CV CSVs;
  outputs to git-ignored `D:\Field2026_analysis_out`.
