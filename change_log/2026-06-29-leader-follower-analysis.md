...
- `wiser/src/wiser_analysis_utils.py` — new "Leader-follower / route-following"
  ...
  - Six plots: peak-score heatmap (leader→follower), best-lag heatmap, asymmetry heatmap, lag curves
    ...
    arrows + timestamps).
- `wiser/notebooks/wiser_pilot_analysis.ipynb` — new **Section J**: runs the
...
Appended to `D:\Field2026_analysis_out\wiser_pilot_output_YYYYMMDD_HHMM\`: `following_scores.csv`,
