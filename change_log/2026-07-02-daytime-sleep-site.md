...
- **`scripts/analyze_daytime_sleep_site.py`** — new driver mirroring
  ...
  to `D:\Field2026_analysis_out\daytime_sleep_site_*`). Georeference/ROI are optional and no-op/provisional
  until confirmed.
...
- **Real-data run (2026-07-03, analysis PC)** on the transferred snapshot
  ...
  written to `D:\Field2026_analysis_out\daytime_sleep_site_*`.
