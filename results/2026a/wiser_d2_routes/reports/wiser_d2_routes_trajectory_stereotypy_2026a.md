...
**Generated (UTC):** 2026-07-10T03:54:50.503491  
**Commit:** `384d1d019d914c19daa3411b2397adeca5e29812`  
**Nights:** 2026-06-28, 2026-06-29, 2026-06-30, 2026-07-01, 2026-07-02, 2026-07-03, 2026-07-04, 2026-07-05, 2026-07-06, 2026-07-07, 2026-07-08  
...
- Mean similarity-to-late-reference went from **0.15** (first night) to **0.89** (last night); night-to-night reproducibility is in `stabilization_metrics.csv` and `plots/stabilization.png`.
- Per-animal stabilization-night estimate (first plateau at ≥90% of own max): {'Siesta': '2026-07-04', 'Hypnos': '2026-07-03', 'Nox': '2026-07-01', 'Sen': '2026-07-07', 'Dormi': '2026-07-07'}.
...
- **Raw** inter-animal occupancy cosine (mean over 10 pairs): **0.93** (high). ROI-transition structure is near-identical too (edge cosine **0.96**).
- After dividing out the pooled shared-corridor 'road', residual **Pearson correlation collapses to -0.01** (residual cosine 0.87 is inflated because residual maps are non-negative — read the **correlation**, not the cosine).
...
|---|---|---|
| **Shared road / environment** | pooled corridor map; residual Pearson -0.01; edge cosine 0.96; most label-perm pairs ≈ null | **primary driver** |
