...
- Read-only on the WISER snapshot + CV CSVs; outputs to git-ignored `D:\Field2026_analysis_out\`.
...
- **Git surface:** only the new/changed script + utils + docs; outputs to `D:\Field2026_analysis_out`
