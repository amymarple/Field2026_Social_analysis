...
`cv/shelter_sleep.py` + `cv/view_quality.py`
...
`cv/glass_regime.py` + `data_manifests/glass_treatments.yaml`
...
- **Cohen's κ is demoted to a base-rate-sensitive *alignment diagnostic* only** — with WISER presence
  ...
  sweep is flat (see
  [`ALIGNMENT_DIAGNOSIS_2026-07-02.md`](../../results/2026a/crossmodal/reports/crossmodal_cv_wiser_alignment_diagnosis_2026a.md)).
